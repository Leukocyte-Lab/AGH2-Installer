...
sshpass -p "$AGH_DB_PASSWORD" scp $SCRIPTPATH/../../artifacts/db/ATTACK-mitre_groups.sql $AGH_DB_USER@$DB_IP:/tmp/
...
sshpass -p "$AGH_MASTER_PASSWORD" scp -r $SCRIPTPATH/../../scripts/ $AGH_MASTER_USER@$IP:/tmp/script/
